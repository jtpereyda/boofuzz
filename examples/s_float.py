...
def define_floats(session):
    ...
    s_float(12.34, s_format=".2f", f_min=10.0, f_max=20.0, max_mutations=10, seed="second_seed", fuzzable=True,
            name="second_float")
    s_static(",")
    ...
    s_float(15.0, s_format="06.2f", f_min=0.0, f_max=1000.0, max_mutations=10, fuzzable=True,
            name="float_leading_zeros")
    s_static(",")
