...
class TestFuzzLoggerCsvFreeFunctions(unittest.TestCase):
    ...
    def test_hex_to_hexstr(self):
        ...
        """
        given = b"abc\n123\r\nA\n"
        expected = "61 62 63 0a 31 32 33 0d 0a 41 0a"
...
class TestFuzzLoggerCsv(unittest.TestCase):
    ...
    def test_close_test_case_flushes_data(self):
        ...
        """
        # When
        self.logger.open_test_case("test_1", name="First Test", index=1)
        self.logger.log_pass("First test passed")
        self.logger.close_test_case()

        self.logger.open_test_case("test_2", name="Second Test", index=2)
